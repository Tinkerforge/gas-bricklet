...
#define GAS_CALIBRATION_DATA_POS       1 // 1 to 13
#define GAS_CALIBRATION_CHECKSUM_POS   14
...
void gas_calibration_read(void) {
	...
	gas.calibration_gas_type               = page[GAS_CALIBRATION_DATA_POS + 11];
	gas.calibration_sensitivity            = page[GAS_CALIBRATION_DATA_POS + 12]; 
...
void gas_calibration_write(void) {
	...
	page[GAS_CALIBRATION_DATA_POS + 11] = gas.calibration_gas_type;
	page[GAS_CALIBRATION_DATA_POS + 12] = gas.calibration_sensitivity;
